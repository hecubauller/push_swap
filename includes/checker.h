...
/*   Updated: 2019/09/25 10:33:17 by huller           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					algo_loop(t_stack **a, t_stack **b, t_instr *in,
						t_sort **p);
void					if_cmnd_a(t_stack **a, t_instr *in,
						t_sort **p, int cnt);
...
void					vizualize_init(t_stack **a, t_stack **b,
						t_instr *instr);
int						add_nbrs(int tmp, t_stack **a, char **argv,
						t_instr *in);
void					vizualize_check(t_stack **a, t_stack **b,
						t_instr *instr);
void					two(t_stack **a, t_stack **b, t_instr *in,
						char **av_str);
int						reader_cycle(char **argv, int *i, int *cnt,
						t_instr **in);
void					freee(t_stack **a, t_stack **b, t_instr *in,
						char **av_str);
void					new_algo(t_stack **a, t_stack **b, t_instr *in,
						t_sort **p);
void					apply_cmnds(t_stack **a, t_stack **b, t_instr *in,
						t_sort **p);
void					cnt_cmnds_a(t_stack **a, t_stack **b, t_instr *in,
						t_sort **p);
void					apply_cmnds2(t_stack **a, t_stack **b, t_instr *in,
						t_sort **p);
void					vizua_2(t_stack **a, t_stack **b, t_stack **tmp_a,
						t_stack **tmp_b);
